...
from ..utils import Bilinear_Pooling


@NECKS.register_module
class RGBXFPN(nn.Module):
    ...
    def __init__(self,
        ...
        self.kernel_size = 11
        self.bilinear_pooling = Bilinear_Pooling(self.out_channels, self.out_channels, self.out_channels)
    ...
    def forward(self, inputs):
        ...
        for i in range(used_backbone_levels - 1, 0, -1):
            ...
            print(temp)
            laterals[i - 1] = self.bilinear_pooling(temp, laterals[i - 1])
