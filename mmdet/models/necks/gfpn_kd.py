...
from ..utils import ConvModule, _GlobalConvModule


@NECKS.register_module
class GFPN_KD(nn.Module):
    ...
    def __init__(self,
        ...
        # count: add how much to kernelsize
        count = 0
        for i in range(self.start_level, self.backbone_end_level):
            ...
            gcn_conv = _GlobalConvModule(
                in_channels[i],
                self.cls_num,
                (20 - (self.kernel_size + count), 20 - (self.kernel_size + count))
            )
    ...
    def forward(self, inputs):
        ...
        laterals = [
            ...
            lateral_conv(gcn_out_lays[i + self.start_level]) for i, lateral_conv in enumerate(self.lateral_convs)
        ]
        # 1x1___________________________________________________________________________________________________________
