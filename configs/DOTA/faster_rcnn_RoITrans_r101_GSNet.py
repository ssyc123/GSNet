...
data_root = '/home/syc/mmdection/CG-Net-master/data/dota1-split-1024/'
img_norm_cfg = dict(
    mean=[123.675, 116.28, 103.53], std=[58.395, 57.12, 57.375], to_rgb=True)     # 个应该要算的把
data = dict(
    imgs_per_gpu=2,
    workers_per_gpu=2,
    train=dict(
...
log_level = 'INFO'
# work_dir = '/home/syc/mmdection/CG-Net-master/syc/faster_rcnn_RoITrans_r101_fpn_baseline'
load_from = None
resume_from = None
workflow = [('train', 1)]
