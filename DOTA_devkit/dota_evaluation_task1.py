...
def voc_eval(detpath,
    ...
    for imagename in imagenames:
        ...
        class_recs[imagename] = {'bbox': bbox,
                                 'difficult': difficult,
                                 'det': det}
    print(f"[INFO] class_recs:{class_recs}")
...
def main():
    ...
    # detpath = r'/home/wzq/remote2/AerialDetection/work_dirs/hrsc_faster_rcnn_RoITrans_r101_fpn_selfatten6_5_rotate_lr0008_1/Task1_results_nms/s.txt'
    detpath = r'/home/syc/mmdection/CG-Net-master/syc/Hrsc_fastrcnn3/epoch20/Task1_results_nms/s.txt'
    annopath = r'/home/syc/mmdection/CG-Net-master/data/HRSC/test/labelTxt/'
    imagesetfile = r'/home/syc/mmdection/CG-Net-master/data/HRSC/test/labelTxt/'
