...
from mmdet.core import results2json, coco_eval, \
    ...
    HBBOBB2Comp4, HBBDet2Comp4, OBBDetComp4_hrsc
...
def parse_args():
    ...
    parser.add_argument('--config', default='/home/syc/mmdection/CG-Net-master/configs/DOTA/faster_rcnn_RoITrans_r101_res_gbfpn_onlinerotate_hrsc.py')
...
def parse_results(config_file, resultfile, dstpath, type):
    ...
    if type == 'OBB':
        #  dota1 has tested
        obb_results_dict = OBBDetComp4_hrsc(dataset, outputs)
        current_thresh = 0.1
    elif type == 'HBB':
        # dota1 has tested
...
if __name__ == '__main__':
    ...
    # pkl_file = os.path.join('work_dirs', config_name, 'epoch12', 'results.pkl')
    # output_path = os.path.join('work_dirs', config_name)

    pkl_file = r"/home/syc/mmdection/CG-Net-master/syc/Hrsc_fastrcnn3/epoch20/results.pkl"
    output_path = r"/home/syc/mmdection/CG-Net-master/syc/Hrsc_fastrcnn3/epoch20"
